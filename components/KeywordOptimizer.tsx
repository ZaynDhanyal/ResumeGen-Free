  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md mt-6">
      <div className="flex items-center mb-4">
        ...
        <h2 className="text-xl font-bold text-gray-800 ml-3">Keyword Optimizer</h2>
      </div>
      ...
      <textarea
        className="w-full h-40 p-3 border rounded-md bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
