  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mt-6">
      <div className="flex items-center mb-4">
        ...
        <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 ml-3">Keyword Optimizer</h2>
      </div>
      ...
      <textarea
        className="w-full h-40 p-3 border dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-700 text-gray-800 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {analysis.presentKeywords.map((kw, i) => (
                <span key={i} className="bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300 text-xs font-medium px-2.5 py-0.5 rounded-full">{kw}</span>
              ))}
            </div>
          </div>
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {analysis.missingKeywords.map((kw, i) => (
                <span key={i} className="bg-red-100 text-red-800 dark:bg-red-900/50 dark:text-red-300 text-xs font-medium px-2.5 py-0.5 rounded-full">{kw}</span>
              ))}
            </div>
          </div>
        </div>
