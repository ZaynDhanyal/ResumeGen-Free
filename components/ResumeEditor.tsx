...
import { PersonalInfoIcon, SummaryIcon, ExperienceIcon, EducationIcon, SkillsIcon, AddIcon, TrashIcon, MagicIcon, DownloadIcon, PaletteIcon, DocumentTextIcon, XCircleIcon, ShareIcon, EyeIcon, InformationCircleIcon, GlobeAltIcon, UsersIcon, IdentificationIcon, CalendarIcon, ShieldCheckIcon } from './icons';
...
const ResumeEditor: React.FC<ResumeEditorProps> = ({
  resumeData, onDataChange, onAddItem, onRemoveItem, templateId, setTemplateId, themeId, setThemeId, onDownloadPdf, formattingOptions, setFormattingOptions, onClearAll, onClearSection, affiliateBanners
}) => {
        ...
        <div className="flex space-x-2 overflow-x-auto pb-2 no-scrollbar">
            ...
            <button
                ...
                onClick={() => {
                    const element = sectionRefs.current[section.id];
                    if (element) {
                        const top = element.offsetTop - 70; // 70px offset for the sticky tab bar
